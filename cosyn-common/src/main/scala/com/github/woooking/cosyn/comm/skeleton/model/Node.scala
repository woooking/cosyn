...
sealed case class ArrayCreationExpr(componentType: Type, initializers: List[Expression]) extends Expression {
    override def toString: String = s"new $componentType[]{${initializers.mkString(", ")}}"
}
