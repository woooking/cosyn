...
object OptionConverters {
    ...
    implicit val specializer_OptionalDouble: SpecializerOfOptions[Double, OptionalDouble] = new SpecializerOfOptions[Double, OptionalDouble] {
    ...
    implicit val specializer_OptionalInt: SpecializerOfOptions[Int, OptionalInt] = new SpecializerOfOptions[Int, OptionalInt] {
    ...
    implicit val specializer_OptionalLong: SpecializerOfOptions[Long, OptionalLong] = new SpecializerOfOptions[Long, OptionalLong] {
